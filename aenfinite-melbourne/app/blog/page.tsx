...
export const metadata: Metadata = {
  ...
  openGraph: {"title":"Web Design & Digital Marketing Blog | Expert Tips & Insights | Aenfinite®","description":"Expert insights on web design, logo design, digital marketing, and branding. Get the latest tips, trends, and strategies to grow your business online.","url":"https://aenfinite.melbourne/blog/","siteName":"Aenfinite","type":"website","images":[{"url":"https://aenfinite.melbourne/wp-content/themes/aenfinite.melbourne/images/thumbnail.jpg"}]},
  twitter: {"card":"summary_large_image","title":"Web Design & Digital Marketing Blog | Aenfinite®","description":"Expert insights on web design, logo design, digital marketing, and branding.","images":["https://aenfinite.melbourne/wp-content/uploads/2024/11/share-image-dd.jpg"]},
...
const pageContent = `<script>
    ...
    <div class="blog-posts">
        ...
        <article class="blog-post">
            <h2><a href="/blog/seo-strategies-2025/">Local SEO Strategies for Melbourne Businesses</a></h2>
            <div class="meta">Published: January 5, 2025 | Category: SEO</div>
            <p>Dominate your local market with these proven SEO strategies specifically designed for Melbourne businesses...</p>
...
export default function Page() {
  return (
    <>
        ...
        "url": "https://aenfinite.melbourne/blog/",
        "publisher": {
            "@type": "Organization",
            "name": "Aenfinite®",
        ...
        "mainEntityOfPage": {
            "@type": "WebPage",
            "@id": "https://aenfinite.melbourne/blog/"
        }
    }` }}
        />
        <script
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://aenfinite.melbourne/blog/"
    }
  ]
}` }}
        />
